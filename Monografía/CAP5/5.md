# Capítulo 05: Creacion de tablas

## 5.1 Base de datos ya creada
[Base de datos](Script_SQL.sql)

## 5.2 Código total copiable
...
## 5.4 Inserción de datos por csv
	Repositorio csv: [](csv)

## 5.5 Inserción de datos manual
