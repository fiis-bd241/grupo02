...
CREATE TABLE Cuenta_Bancaria( ID_Cuenta_B INTEGER primary key, Numero_Cuenta VARCHAR(32), Nombre_Banco VARCHAR(32), Tipo_Cuenta VARCHAR(32), Moneda VARCHAR(10), ID_Empleado INTEGER, FOREIGN KEY (ID_Empleado) REFERENCES Empleado(ID_Empleado) );
CREATE TABLE Modificacion( ID_Modificacion INTEGER primary key, Monto_Modificacion DECIMAL(10,2), Tipo_Modificacion VARCHAR(32) );
CREATE TABLE Sueldo( ID_Sueldo INTEGER primary key, Monto_Salario_Bruto DECIMAL(10,2) );
CREATE TABLE Pago_Total( ID_Pago_Total INTEGER primary key, Monto_Pagar DECIMAL(10,2), ID_Sueldo INTEGER, ID_Modificacion INTEGER, FOREIGN KEY (ID_Sueldo) REFERENCES Sueldo(ID_Sueldo), FOREIGN KEY (ID_Modificacion) REFERENCES Modificacion(ID_Modificacion) );
CREATE TABLE Nomina( ID_Nomina INTEGER primary key, Fecha_Emision DATE, Periodo_Pago VARCHAR(10), ID_Empleado INTEGER, ID_Pago_Total INTEGER, FOREIGN KEY (ID_Empleado) REFERENCES Empleado(ID_Empleado), FOREIGN KEY (ID_Pago_Total) REFERENCES Pago_Total(ID_Pago_Total) );
CREATE TABLE Supervisor( ID_Supervisor INTEGER primary key, ID_Empleado INTEGER, FOREIGN KEY (ID_Empleado) REFERENCES Empleado(ID_Empleado) ); 
CREATE TABLE Cese( ID_Cese INTEGER primary key, EstadoCese VARCHAR(32), FechaInicioCese DATE, ID_Empleado INTEGER, FOREIGN KEY (ID_Empleado) REFERENCES Empleado(ID_Empleado) ); 
CREATE TABLE Cuestionario_Salida( ID_Cuestionario INTEGER primary key, ID_Supervisor INTEGER, ID_Cese INTEGER, Fecha_Cuestionario DATE, FOREIGN KEY (ID_Supervisor) REFERENCES Supervisor(ID_Supervisor), FOREIGN KEY (ID_Cese) REFERENCES Cese(ID_Cese)	 ); 
CREATE TABLE Pregunta_Salida( ID_Pregunta INTEGER primary key, Pregunta_Salida VARCHAR(256), Respuesta_Salida VARCHAR(256), ID_Cuestionario INTEGER, FOREIGN KEY (ID_Cuestionario) REFERENCES Cuestionario_Salida(ID_Cuestionario) ); 
CREATE TABLE Beneficios_Cese( ID_Beneficios INTEGER primary key, Tipo VARCHAR(32), Monto FLOAT, ID_Cese INTEGER, FOREIGN KEY (ID_Cese) REFERENCES Cese(ID_Cese) ); 
CREATE TABLE Programa_Capacitador(ID_Programa_C INTEGER primary key,Fecha_Inicio DATE,Fecha_Fin DATE,Motivo VARCHAR(256),ID_Departamento INTEGER, FOREIGN KEY(ID_Departamento) REFERENCES Departamento(ID_Departamento)); 
CREATE TABLE Lista_Matricula(ID_Programa_C INTEGER ,ID_Empleado INTEGER,Estado_Matricula VARCHAR(256), FOREIGN KEY(ID_Programa_C) REFERENCES Programa_Capacitador(ID_Programa_C), FOREIGN KEY(ID_Empleado) REFERENCES Empleado(ID_Empleado)
);
CREATE TABLE Sesion( ID_Sesion INTEGER primary key, Estado VARCHAR(64), Fecha DATE, Hora TIME, ID_Programa_C INTEGER, FOREIGN KEY(ID_Programa_C) REFERENCES Programa_Capacitador(ID_Programa_C) ); 
CREATE TABLE Empleado_Sesion( ID_Sesion INTEGER , ID_Empleado INTEGER, Asistencia VARCHAR(64), FOREIGN KEY(ID_Sesion) REFERENCES Sesion(ID_Sesion), FOREIGN KEY(ID_Empleado) REFERENCES Empleado(ID_Empleado) ); 
CREATE TABLE Evaluacion_Capacitacion(ID_Evaluacion INTEGER primary key,Duracion_Evaluacion INTEGER,Hora TIME,ID_Instructor INTEGER,FOREIGN KEY(ID_Instructor) REFERENCES Empleado(ID_Empleado));
CREATE TABLE Evaluacion_Sesion( ID_Evaluacion INTEGER, ID_Sesion INTEGER, Resultado VARCHAR(64),FOREIGN KEY(ID_Sesion) REFERENCES Sesion(ID_Sesion),FOREIGN KEY(ID_Evaluacion) REFERENCES Evaluacion_Capacitacion(ID_Evaluacion)); 
CREATE TABLE Evaluacion_Empleado(ID_Evaluacion INTEGER,ID_Empleado INTEGER,Resultado VARCHAR(64),FOREIGN KEY(ID_Empleado) REFERENCES Empleado(ID_Empleado),FOREIGN KEY(ID_Evaluacion) REFERENCES Evaluacion_Capacitacion(ID_Evaluacion));
CREATE TABLE Permiso( ID_Permiso INTEGER primary key, ID_Empleado INTEGER , ID_Supervisor INTEGER, Tipo VARCHAR(64), Motivo VARCHAR(128), Duracion Varchar(64), Estado VARCHAR(64), FOREIGN KEY(ID_Empleado) REFERENCES Empleado(ID_Empleado), FOREIGN KEY(ID_Supervisor) REFERENCES Supervisor(ID_Supervisor) );
CREATE TABLE Licencia( ID_Licencia INTEGER primary key, ID_Empleado INTEGER , ID_Supervisor INTEGER, Tipo VARCHAR(64), Fecha_inicio DATE, Fecha_fin DATE, Estado VARCHAR(64), FOREIGN KEY(ID_Empleado) REFERENCES Empleado(ID_Empleado), FOREIGN KEY(ID_Supervisor) REFERENCES Supervisor(ID_Supervisor) ); 
CREATE TABLE Asistencia( ID_Asistencia INTEGER primary key, ID_Empleado INTEGER , Estado VARCHAR(64), Observacion VARCHAR (128), Fecha DATE, Hora_entrada TIME, Hora_salida TIME, FOREIGN KEY(ID_Empleado) REFERENCES Empleado(ID_Empleado) ); 
CREATE TABLE Gerente_RR_HH( ID_Gerente INTEGER, ID_Empleado INTEGER, PRIMARY KEY(ID_Gerente), FOREIGN KEY(ID_Empleado) REFERENCES Empleado(ID_Empleado) );
CREATE TABLE Especialista_Relaciones_Laborales( ID_Especialista INTEGER, ID_Empleado INTEGER, PRIMARY KEY(ID_Especialista), FOREIGN KEY(ID_Empleado) REFERENCES Empleado(ID_Empleado) );
CREATE TABLE Cuestionario( ID_Cuestionario INTEGER, Tipo_Cuestionario VARCHAR(15), PRIMARY KEY(ID_Cuestionario) );
CREATE TABLE Pregunta_Cuestionario( ID_Pregunta INTEGER, ID_Cuestionario INTEGER, Enunciado_Pregunta VARCHAR(256), PRIMARY KEY(ID_Pregunta), FOREIGN KEY(ID_Cuestionario) REFERENCES Cuestionario(ID_Cuestionario) );
CREATE TABLE Cuestionario_Empleado( ID_Empleado INTEGER, ID_Cuestionario INTEGER, ID_Pregunta INTEGER,  Respuesta VARCHAR(15), Fecha_Rellenado DATE, Hora_Rellenado TIME, FOREIGN KEY(ID_Empleado) REFERENCES Empleado(ID_Empleado),	 FOREIGN KEY(ID_Cuestionario) REFERENCES Cuestionario(ID_Cuestionario), FOREIGN KEY(ID_Pregunta) REFERENCES Pregunta_Cuestionario(ID_Pregunta) );
CREATE TABLE Cuestionario_Especialista( ID_Cuestionario INTEGER, ID_Especialista INTEGER, Fecha_Creacion DATE, Hora_Creacion TIME, Fecha_Envio_Gerencia DATE, Hora_Envio_Gerencia TIME, FOREIGN KEY(ID_Cuestionario) REFERENCES Cuestionario(ID_Cuestionario),	 FOREIGN KEY(ID_Especialista) REFERENCES Especialista_Relaciones_Laborales(ID_Especialista));
CREATE TABLE Cuestionario_Gerente_RR_HH( ID_Cuestionario INTEGER, ID_Gerente INTEGER, Fecha_Revision DATE, Hora_Revision TIME, Estado_Aprobacion VARCHAR (256), FOREIGN KEY(ID_Cuestionario) REFERENCES Cuestionario(ID_Cuestionario),	 FOREIGN KEY(ID_Gerente) REFERENCES Gerente_RR_HH(ID_Gerente));
...
INSERT INTO Nomina (ID_Nomina, Fecha_Emision, Periodo_Pago, ID_Empleado, ID_Pago_Total) VALUES (2001, '2024-04-15', 'Quincenal', 20210001, 1), (2002, '2024-04-30', 'Mensual', 20220004, 1), (2003, '2024-03-31', 'Mensual', 20240023, 1), (2004, '2024-05-15', 'Quincenal', 20200034, 1), (2005, '2024-05-31', 'Mensual', 20200008, 1); 
INSERT INTO Supervisor VALUES (1, 20230007), (2, 20200004), (3, 20200006), (4, 20200005), (5, 20200009), (6, 20200007), (7, 20200008), (8, 20200010), (9, 20220005), (10, 20230013), (11, 20200016), (12, 20200019), (13, 20200022), (14, 20200023), (15, 20210009), (16, 20200025), (17, 20200026), (18, 20200028), (19, 20200029), (20, 20200030), (21, 20200031), (22, 20200034), (23, 20200037); 
...
INSERT INTO Lista_Matricula VALUES (1,'20230011','Matriculado'),(1,'20240006','Matriculado'),(1,'20240024','Matriculado'),(1,'20240021','Matriculado'),(1,'20240010','Retirado');
...
INSERT INTO Cuestionario_Empleado(ID_Empleado,ID_Cuestionario,ID_Pregunta,Respuesta,Fecha_Rellenado,Hora_Rellenado) VALUES (20210005,1,1001,'Positivo','2024-06-15','15:30'), (20210005,1,1002,'Muy Negativo','2024-06-15','15:30'), (20210009,2,2001,'Muy positivo','2024-06-17','18:30'), (20210009,2,2002,'Muy Negativo','2024-06-17','18:30'), (20210002,3,3001,'Positivo','2024-06-14','19:30'), (20210002,3,3001,'Muy Positivo','2024-06-14','19:30'), (20200001,4,4001,'Negativo','2024-06-13','12:30'), (20200001,4,4002,'Muy Positivo','2024-06-13','12:30'), (20220006,1,1001,'Negativo','2024-06-15','17:30'), (20220006,1,1002,'Muy Negativo','2024-06-15','17:30'), (20220005,2,2001,'Positivo','2024-06-17','11:30'), (20220005,2,2002,'Muy Negativo','2024-06-17','11:30'), (20210007,3,3001,'Positivo','2024-06-14','20:30'), (20210007,3,3001,'Positivo','2024-06-14','20:30');
...
INSERT INTO Reporte(ID_Reporte,ID_Empleado,ID_Cuestionario,Fecha_Ingreso_Empleado,Calificacion_Empleado) VALUES (1,20210005,1,'2024-01-15','Positivo'), (2,20210009,2,'2023-05-12','Negativo'), (3,20210002,3,'2023-08-11','Positivo'), (4,20200001,4,'2023-09-16','Negativo'), (5,20220006,1,'2023-05-14','Negativo'), (6,20220005,2,'2023-07-13','Negativo'), (7,20210007,3,'2023-12-21','Negativo');
